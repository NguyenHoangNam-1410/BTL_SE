...
INSERT INTO `file` (student_id, file_type_id, file_path, filename, status, size_in_bytes, upload_at)
VALUES 
(1, 1, '/uploads/student1/', 'document1.pdf', 'uploaded', 204800, NOW()),
(1, 2, '/uploads/student1/', 'image1.png', 'uploaded', 512000, NOW()),
(2, 1, '/uploads/student2/', 'document2.pdf', 'uploaded', 102400, NOW());
